    ...
    try {
      ...
      if (kDebugMode) {
        ...
        if (e is SocketException) {
          log('====> Socket Exception - No internet or server unreachable');
        } else if (e is TimeoutException) {
          log('====> Timeout Exception - Request took longer than $timeoutInSeconds seconds');
        } else if (e is FormatException) {
          log('====> Format Exception - JSON parsing or URL format issue');
        }
      }
      return Response(statusCode: 1, statusText: noInternetMessage);
    }
